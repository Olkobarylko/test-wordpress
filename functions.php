...
function mogo_setup()
{
	/*
		...
		* If you're building a theme based on Mogo, use a find and replace
		* to change 'mogo' to the name of your theme in all the template files.
		*/
...
{
	wp_enqueue_style('mogo-style', get_stylesheet_uri(), array(), _S_VERSION);
	...
	wp_enqueue_script('mogo-custom', get_template_directory_uri() . '/js/custom.js', array('jquery'), _S_VERSION, true);
